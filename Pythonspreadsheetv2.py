...
class Sheet:
    ...
    def list_Chores (self):
        self.nameOfMember = input ("Name of housemate to perform the chore")
        self.whatIsTheChore = input( "Description of chore: ")
        self.sheet.update_cell(8,8,nameOfMember)
        self.sheet.update_cell(8,9,whatIsTheChore)
